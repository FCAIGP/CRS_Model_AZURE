...
def predict():
	...
	filtered_df['Probability'] = filtered_df['Probability'].round(decimals=precision)
	...
	return json.dumps({'input':text,'cleaned':cleaned,'threshold':threshold,'precision':precision,'prediction': OrderedDict(preds_dict_sorted)})
